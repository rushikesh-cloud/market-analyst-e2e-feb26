...
- Use LangChain components where they fit: Azure Document Intelligence loading, markdown header splitting, recursive chunk refinement, Azure OpenAI embeddings, and Postgres vector storage.
